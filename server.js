...
let fundoDaCarta = "https://i0.wp.com/www.multarte.com.br/wp-content/uploads/2019/01/free-flyers-background-png.png?resize=696%2C696&ssl=1";
let imagens = [
    {
        'nome': 'css',
...
app.get("/game", (req, res) => {
    ...
    gameHTML = layoutBase;
    gameHTML += `<p class="pontuacao">${player1} hits = ${Math.floor(((player1clicks - (errosPlayer1 * 2)) / 2))}, ${player2} hits = ${Math.floor(((player2clicks - (errosPlayer2 * 2)) / 2))}</p>
                 <h2 class="turno">
    ...
    gameHTML = func.montarTabela(linhas, colunas, gameHTML, imagensPraTabela, arrayFundo, fundoDaCarta, queryVariavels);
...
app.get("/gaming", (req, res) => {
    ...
    gamingHTML += ` <p class="pontuacao">
                        ${player1} hits = ${Math.floor(((player1clicks - (errosPlayer1 * 2)) / 2))},
                        ${player2} hits = ${Math.floor(((player2clicks - (errosPlayer2 * 2)) / 2))}
                    </p>
                    <h2 class="turno">
    ...
    let renderGamingHTML = func.montarTabela(linhas, colunas, gamingHTML, imagensPraTabela, arrayFundo, fundoDaCarta, queryVariavels);
